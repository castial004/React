function TeamInfo(props){
  ...
  <div className="mx-auto grid max-w-7xl gap-20 px-6 lg:px-8 xl:grid-cols-3">
    <div Name="max-w-xl">
      ...
      <p className="mt-6 text-lg/8 text-gray-600">{props.about}</p>
    </div>
    <ul role="list" className="grid gap-x-8 gap-y-12 sm:grid-cols-2 sm:gap-y-16 xl:col-span-2">
      <li>
        <div Name="flex items-center gap-x-6">
          ...
          <div>
            <h3 className="text-base/7 font-semibold tracking-tight text-gray-900">{props.username}</h3>
