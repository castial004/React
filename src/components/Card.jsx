...
export default function Card() {
    ...
    return (
        <div className={`${themeMode.themeMode==='light'?'w-full bg-black border border-gray-200 rounded-lg shadow':'w-full bg-gray-500 border border-gray-700 rounded-lg shadow'}`}>
            <a href="/">
